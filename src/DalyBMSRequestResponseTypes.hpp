...
STATIC_IF_ARDUINO_IDE String toString (const OperationalMode operationalMode) {
    ...
    case OperationalMode::LongPressPowerOnOff :
        return "long-press power-on/off";
    default :
        return String ("0x") + String (static_cast<uint8_t> (operationalMode), HEX);
    }
}
...
STATIC_IF_ARDUINO_IDE String toString (const BatteryType batteryType) {
    ...
    case BatteryType::LithiumIon :
        return "lithium-ion";
    default :
        return String ("0x") + String (static_cast<uint8_t> (batteryType), HEX);
    }
}
...
template <>
constexpr const char *RequestResponse_TYPE_STRING<0x54, 1>::getTypeName () {
...
template <>
constexpr const char *RequestResponse_TYPE_STRING<0x57, 5>::getTypeName () {
...
template <>
constexpr const char *RequestResponse_TYPE_THRESHOLD_MINMAX<0x59, float, 2, FrameContentDecoder::decode_Voltage_m>::getTypeName () {
...
template <>
constexpr const char *RequestResponse_TYPE_THRESHOLD_MINMAX<0x5A, float, 2, FrameContentDecoder::decode_Voltage_d>::getTypeName () {
...
template <>
constexpr const char *RequestResponse_TYPE_THRESHOLD_MINMAX<0x5B, float, 2, FrameContentDecoder::decode_Current_d>::getTypeName () {
...
template <>
constexpr const char *RequestResponse_TYPE_THRESHOLD_MINMAX<0x5D, float, 2, FrameContentDecoder::decode_Percent_d>::getTypeName () {
...
template <>
constexpr const char *RequestResponse_TYPE_STRING<0x62, 2>::getTypeName () {
...
template <>
constexpr const char *RequestResponse_TYPE_STRING<0x63, 2>::getTypeName () {
...
template <>
constexpr const char *RequestResponse_TYPE_VALUE_MINMAX<0x91, float, 2, FrameContentDecoder::decode_Voltage_m>::getTypeName () {
...
template <>
constexpr const char *RequestResponse_TYPE_VALUE_MINMAX<0x92, int8_t, 1, FrameContentDecoder::decode_Temperature>::getTypeName () {
...
STATIC_IF_ARDUINO_IDE String toString (const ChargeState state) {
    ...
    case ChargeState::Discharge :
        return "discharge";
    default :
        return String ("0x") + String (static_cast<uint8_t> (state), HEX);
    }
}
...
protected:
    ...
    using RequestResponseCommand<COMMAND>::setResponseFrameCount;
    bool processResponseFrame (const RequestResponseFrame &frame, const size_t frameNum) override {
        if (FRAMENUM && (frame.getUInt8 (0) != frameNum || frame.getUInt8 (0) > (values.size () / ITEMS_PER_FRAME) + 1))
            return false;
...
template <>
constexpr const char *RequestResponse_TYPE_ARRAY<0x95, float, 2, 48, 3, true, FrameContentDecoder::decode_Voltage_m>::getTypeName () {
...
template <>
constexpr const char *RequestResponse_TYPE_ARRAY<0x96, int8_t, 1, 16, 7, true, FrameContentDecoder::decode_Temperature>::getTypeName () {
...
template <>
constexpr const char *RequestResponse_TYPE_ARRAY<0x97, uint8_t, 1, 48, 48, false, FrameContentDecoder::decode_BitNoFrameNum>::getTypeName () {
...
template <>
constexpr const char *RequestResponseCommand<0x00>::getTypeName () {
...
template <>
constexpr const char *RequestResponse_TYPE_ONOFF<0xD9>::getTypeName () {
...
template <>
constexpr const char *RequestResponse_TYPE_ONOFF<0xDA>::getTypeName () {
...
template <typename TYPE>
constexpr const char *getName (const TYPE &) {
